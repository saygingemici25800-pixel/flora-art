...
export const products: Product[] = [
  ...
  { id: 'wedding-bq',    name: 'Düğün Buketi',           price: 1200, category: 'wedding',       motif: 'wedding',                     image: IMG('dugun-buketi') },
  ...
  { id: 'engagement-fl', name: 'Nişan Çiçeği',           price: 850,  category: 'wedding',       motif: 'wedding',   badge: 'holland', image: IMG('nisan-cicegi') },
  { id: 'office-orchid', name: 'Ofis Orkidesi',          price: 680,  category: 'corporate',     motif: 'orchid',    badge: 'fast',    image: IMG('ofis-orkidesi') },
  { id: 'terrarium',     name: 'Teraryum',               price: 420,  category: 'plant',         motif: 'terrarium', badge: 'new',     image: IMG('teraryum') },
  { id: 'intl-premium',  name: 'Uluslararası Premium',   price: 1500, category: 'international', motif: 'premium',   badge: 'premium', image: IMG('intl-premium') },
]

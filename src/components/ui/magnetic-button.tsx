/**
 * Wraps its children in a "magnetic" wrapper: on hover the element eases toward
 * the cursor and springs back on leave. Pointer-driven, so it stays inert on
 * touch devices (no hover) — the wrapped control behaves normally there.
 */

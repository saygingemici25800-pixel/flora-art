...
const BOUQUET: Entry[] = [
  ...
  { name: 'Pembe Spray Gül Buketi', image: '/images/products/pexels/pembe-spray-gul-buket.webp', price: 1500, badge: 'new' },
  { name: "11'li Pembe Gül Buketi", image: '/images/products/pexels/pembe-gul-limonyum.webp', price: 2200, featured: true },
  { name: 'Kırmızı-Pembe Gül Buketi', image: '/images/products/pexels/kirmizi-pembe-gul-vazo.webp', price: 3200 },
  { name: 'Renkli Büyük Gül Buketi', image: '/images/products/pexels/renkli-buyuk-gul-buket.webp', price: 8500, badge: 'premium' },
  { name: 'Kırmızı Gül Aşk Buketi', image: '/images/products/pexels/kirmizi-gul-kraft-kedi.webp', price: 7900, oldPrice: 9000, badge: 'premium' },
  ...
  { name: 'Beyaz Krizantem Buketi', image: '/images/products/pexels/beyaz-krizantem-buket.webp', price: 1350, motif: 'anemone' },
  { name: 'Pembe Karanfil Buketi', image: '/images/products/pexels/pembe-karanfil-buket.webp', price: 1250, oldPrice: 1500 },
  ...
  { name: 'Pembe Lale & Dahlia Buketi', image: '/images/products/pexels/pembe-lale-dahlia-buket.webp', price: 1650, motif: 'tulip', badge: 'new' },
...
const BOX: Entry[] = [
  ...
  { name: 'Pembe Gül Vazo', image: '/images/products/pexels/pembe-gul-vazo.webp', price: 1250, badge: 'new' },
  { name: 'Siyah Kutuda Pembe Spray Gül', image: '/images/products/pexels/pembe-spray-gul-siyah.webp', price: 1850, featured: true },
  ...
  { name: 'Altın Silindirde Güller', image: '/images/products/pexels/altin-silindir-gul.webp', price: 4950, oldPrice: 5500, badge: 'premium' },
...
const WEDDING: Entry[] = [
  ...
  { name: 'Pembe Lilyum & Gül Buketi', image: '/images/products/pexels/pembe-lilyum-gul-yakin.webp', price: 5500, motif: 'peony', badge: 'premium' },
]

const CORPORATE: Entry[] = [
  { name: 'Açılış Çelengi', price: 3500, featured: true },
  { name: 'Tören Çelengi', price: 3250 },
  { name: 'Tropikal Ayaklı Aranjman', image: '/images/products/pexels/tropikal-ayakli-aranjman.webp', price: 5500, oldPrice: 6500, badge: 'premium', featured: true },
  ...
  { name: 'Turuncu-Mavi Tropikal Stand', image: '/images/products/pexels/turuncu-mavi-tropikal-stand.webp', price: 4250, oldPrice: 4900 },

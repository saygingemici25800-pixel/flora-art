...
const BOUQUET: Entry[] = [
  { name: "5'li Kırmızı Gül Buketi", image: '/images/products/pexels/kirmizi-gul-buket-kurdele.webp', price: 1250 },
  { name: "7'li Kırmızı Gül Buketi", image: '/images/products/pexels/kirmizi-gul-7.webp', price: 1500, badge: 'new' },
  { name: "11'li Pembe Gül Buketi", image: '/images/products/pexels/pembe-gul-limonyum.webp', price: 2200, featured: true },
  { name: "21'li Kırmızı Gül Buketi", image: '/images/products/pexels/kirmizi-gul-21.webp', price: 3200 },
  { name: '41 Gül Kız İsteme Buketi', image: '/images/products/pexels/kiz-isteme-41.webp', price: 8500, badge: 'premium' },
  { name: '41 Kırmızı Gül Aşk Buketi', image: '/images/products/pexels/ask-buketi-41.webp', price: 7900, oldPrice: 9000, badge: 'premium' },
  { name: 'Lüks Kırmızı Gül Buketi', image: '/images/products/pexels/luks-kirmizi-gul-buket.webp', price: 6500, badge: 'premium', featured: true },
  { name: 'Papatya Buketi', image: '/images/products/pexels/beyaz-papatya-buket.webp', price: 1850 },
  { name: 'Sarı-Turuncu Gül Buketi', image: '/images/products/pexels/sari-turuncu-gul-vazo.webp', price: 1650, badge: 'new' },
  { name: 'Renkli Spray Gül Buketi', image: '/images/products/pexels/renkli-spray-gul-mavi.webp', price: 2450 },
  { name: 'Kırmızı-Pembe Güller', image: '/images/products/pexels/kirmizi-pembe-gul-ahsap.webp', price: 2750, oldPrice: 3300, featured: true },
  { name: 'Pembe-Beyaz Gül Buketi', image: '/images/products/pexels/pembe-beyaz-gul-kraft.webp', price: 2350 },
  { name: 'Pembe Gül & Orkide Buketi', image: '/images/products/pexels/pembe-gul-orkide-buket.webp', price: 2650 },
  { name: 'Pembe Gül Buketi', image: '/images/products/pexels/pembe-gul-buket-keten.webp', price: 1950 },
  { name: 'Beyaz Gül Buketi', image: '/images/products/pexels/beyaz-gul-vazo.webp', price: 1950, badge: 'holland' },
  { name: 'Mevsim Buketi', image: '/images/products/pexels/mevsim-buket-yaz.webp', price: 1450, badge: 'fast', featured: true },
  { name: 'Baharın Şenliği Buketi', image: '/images/products/pexels/baharin-senligi-buket.webp', price: 1350, badge: 'new' },
  { name: 'Bahar Aranjmanı', image: '/images/products/pexels/bahar-aranjman-karanfil.webp', price: 1250 },
  { name: 'Gerbera & Ayıcık Buketi', image: '/images/products/pexels/gerbera-ayicik-buket.webp', price: 1550, motif: 'anemone' },
  { name: 'Pembe Gül & Gerbera Buketi', image: '/images/products/pexels/pembe-gul-gerbera-buket.webp', price: 1650, motif: 'anemone' },
  { name: 'Renkli Karanfil Buketi', image: '/images/products/pexels/renkli-karanfil-buket.webp', price: 1750, oldPrice: 2100, featured: true },
  { name: 'Pembe-Somon Gül Vazo', image: '/images/products/pexels/pembe-somon-gul-vazo.webp', price: 1850, motif: 'anemone' },
  { name: 'Pembe Aster Buketi', image: '/images/products/pexels/pembe-aster-buket.webp', price: 1650 },
  { name: 'Lüks Papatya Buketi', image: '/images/products/pexels/luks-papatya-buket.webp', price: 2250, motif: 'anemone', badge: 'premium' },
  { name: 'Beyaz Lilyum Aranjmanı', image: '/images/products/pexels/beyaz-lilyum-buket.webp', price: 1950 },
  { name: 'Lilyum & Gül Buketi', image: '/images/products/pexels/lilyum-gul-buket.webp', price: 2450, featured: true },
  { name: 'Papatya & Cipso Buketi', image: '/images/products/pexels/papatya-cipso-buket.webp', price: 1750, motif: 'anemone' },
  { name: 'Kasımpatı Buketi', image: '/images/products/pexels/kasimpati-buketi.webp', price: 1350, motif: 'anemone' },
  { name: 'Karanfil Buketi', image: '/images/products/pexels/karanfil-buketi.webp', price: 1250, oldPrice: 1500 },
  { name: 'Şakayık & Ranunculus Buketi', image: '/images/products/pexels/sakayik-ranunculus-buket.webp', price: 2950, motif: 'peony', badge: 'premium', featured: true },
  { name: 'Lale Buketi', image: '/images/products/pexels/lale-buketi.webp', price: 1650, motif: 'tulip', badge: 'new' },
  { name: 'Sümbül Aranjmanı', image: '/images/products/pexels/sumbul-aranjman.webp', price: 2150, motif: 'peony' },
  { name: 'Ayıcıklı Gerbera Aranjmanı', image: '/images/products/pexels/ayicik-gerbera-aranjman.webp', price: 1850, featured: true },
  { name: 'Mevsim Demeti', image: '/images/products/pexels/mevsim-demeti.webp', price: 1150 },
]

const BOX: Entry[] = [
  { name: 'Krem Kutuda Kırmızı Güller', image: '/images/products/pexels/krem-kutu-kirmizi-gul.webp', price: 2450, featured: true },
  { name: 'Mor Lisianthus & Gül Kutu', image: '/images/products/pexels/mor-lisianthus-gul-kutu.webp', price: 2250 },
  { name: 'Siyah Kutuda Kırmızı Gül', image: '/images/products/pexels/siyah-kutu-kirmizi-gul.webp', price: 2950, oldPrice: 3500, badge: 'premium', featured: true },
  { name: 'Kırmızı Gül Kutu Aranjman', image: '/images/products/pexels/kirmizi-gul-kutu-aranjman.webp', price: 1650, badge: 'fast' },
  { name: 'Pembe-Mor Dahlia Kutu', image: '/images/products/pexels/pembe-mor-dahlia-kutu.webp', price: 4500, badge: 'premium' },
  { name: 'Pembe Gül Hatbox', image: '/images/products/pexels/pembe-gul-hatbox.webp', price: 2350 },
  { name: 'Beyaz Kutuda Orkide', price: 2750, motif: 'orchid', badge: 'holland' },
  { name: 'Sarı Gül & Lale Kutu', image: '/images/products/pexels/sari-gul-lale-kutu.webp', price: 1950 },
  { name: 'Kutuda Papatya', price: 1450, motif: 'anemone', badge: 'new' },
  { name: 'Altın Kutuda Kırmızı Güller', image: '/images/products/pexels/altin-kutu-kirmizi-gul.webp', price: 2650, featured: true },
  { name: 'Kırmızı Gül & Okaliptüs Kutu', image: '/images/products/pexels/kirmizi-gul-okaliptus-kutu.webp', price: 2450, oldPrice: 2900 },
  { name: 'Sarı-Beyaz Gül Kutu', image: '/images/products/pexels/sari-beyaz-gul-kutu.webp', price: 4250, badge: 'premium', featured: true },
  { name: 'Mini Kutu Çiçek', image: '/images/products/pexels/mini-kutu.webp', price: 1250, badge: 'new' },
  { name: 'Çikolatalı Kutu Çiçek', image: '/images/products/pexels/cikolatali-kutu.webp', price: 1850, featured: true },
  { name: 'Somon Gül Silindir Kutu', image: '/images/products/pexels/somon-gul-silindir-kutu.webp', price: 2150 },
  { name: 'Beyaz Gül & Lale Kutu', image: '/images/products/pexels/beyaz-gul-lale-kutu.webp', price: 2250 },
  { name: 'Beyaz Gül Aranjman', image: '/images/products/pexels/beyaz-gul-aranjman-cam.webp', price: 1950 },
  { name: 'Turuncu-Sarı Gül Aranjman', image: '/images/products/pexels/turuncu-sari-gul-aranjman.webp', price: 2550, oldPrice: 3000 },
  { name: 'Altın Silindirde Kırmızı-Beyaz Gül', image: '/images/products/pexels/altin-silindir-kirmizi-beyaz-gul.webp', price: 4750, badge: 'premium' },
  { name: 'Mor Gül Kova Aranjman', image: '/images/products/pexels/mor-gul-kova-aranjman.webp', price: 2850, motif: 'orchid', badge: 'holland' },
  { name: 'Şampanya Gül Vazo', image: '/images/products/pexels/sampanya-gul-vazo.webp', price: 3250, motif: 'peony', badge: 'premium', featured: true },
  { name: 'Lüks Gül Kutusu', image: '/images/products/pexels/luks-gul-kutusu.webp', price: 4950, oldPrice: 5500, badge: 'premium' },
  { name: 'Kutuda Kırmızı & Beyaz', price: 2350 },
  { name: 'Kutuda Gül ve Lilyum', price: 2450 },
  { name: 'Renkli Bahçe Silindir Kutu', image: '/images/products/pexels/renkli-bahce-silindir-kutu.webp', price: 3950, badge: 'premium' },
]

const PLANT: Entry[] = [
  { name: 'İki Dallı Mor Orkide', price: 2450, motif: 'orchid', featured: true },
  { name: 'Benekli Orkide Saksı', image: '/images/products/pexels/benekli-orkide-saksi.webp', price: 2450, motif: 'orchid' },
  { name: 'Beyaz Orkide (Pencere)', image: '/images/products/pexels/beyaz-orkide-pencere.webp', price: 2250, motif: 'orchid', badge: 'holland' },
  { name: 'Beyaz Orkide (Seramik)', image: '/images/products/pexels/beyaz-orkide-seramik.webp', price: 2650, oldPrice: 3100, motif: 'orchid', featured: true },
  { name: 'Pembe Calla (Bahçe)', image: '/images/products/pexels/pembe-calla-bahce.webp', price: 2350, motif: 'orchid' },
  { name: 'Pembe Calla Saksı', image: '/images/products/pexels/pembe-calla-saksi.webp', price: 1450, motif: 'orchid', badge: 'new' },
  { name: 'Spathiphyllum (Barış Çiçeği)', price: 1250, motif: 'terrarium' },
  { name: 'Turuncu Bromelia', image: '/images/products/pexels/turuncu-bromelia.webp', price: 1350, motif: 'terrarium' },
  { name: 'Antoryum', image: '/images/products/pexels/antoryum.webp', price: 1550, motif: 'terrarium', featured: true },
  { name: 'Ficus Bonsai', image: '/images/products/pexels/ficus-bonsai.webp', price: 1950, motif: 'terrarium' },
  { name: 'Sukulent Aranjman', price: 1150, motif: 'terrarium', badge: 'new' },
  { name: 'Kaktüs Bahçesi', image: '/images/products/pexels/kaktus-bahcesi.webp', price: 1250, motif: 'terrarium' },
  { name: 'Areka Palmiyesi', image: '/images/products/pexels/areka-palmiyesi.webp', price: 1850, motif: 'terrarium' },
  { name: 'Pilea (Para Bitkisi)', image: '/images/products/pexels/pilea-para-bitkisi.webp', price: 1650, motif: 'terrarium' },
  { name: 'Yucca', price: 1750, motif: 'terrarium' },
  { name: 'Lilyum Dal Saksı', image: '/images/products/pexels/lilyum-dal-saksi.webp', price: 1450, motif: 'terrarium' },
  { name: 'Difenbahya', image: '/images/products/pexels/difenbahya.webp', price: 1550, oldPrice: 1850, motif: 'terrarium' },
  { name: 'Sardunya', image: '/images/products/pexels/sardunya.webp', price: 1050, motif: 'terrarium' },
  { name: 'Üç Dallı Beyaz Orkide', image: '/images/products/pexels/uc-dalli-beyaz-orkide.webp', price: 3000, motif: 'orchid', badge: 'premium', featured: true },
  { name: 'Mini Sukulent', price: 1000, motif: 'terrarium', badge: 'new' },
]

const WEDDING: Entry[] = [
  { name: 'Beyaz Lilyum Gelin Buketi', image: '/images/products/pexels/beyaz-lilyum-gelin-buket.webp', price: 3500, featured: true },
  { name: 'Beyaz Gül Gelin Buketi', image: '/images/products/pexels/beyaz-gul-gelin-buket.webp', price: 3250 },
  { name: 'Söz Masası Aranjmanı', image: '/images/products/pexels/soz-masasi.webp', price: 4500, oldPrice: 5200, featured: true },
  { name: 'Pembe Lilyum & Gül Nişan Buketi', image: '/images/products/pexels/pembe-lilyum-gul-nisan.webp', price: 3850 },
  { name: 'Araba Süsleme', image: '/images/products/pexels/araba-susleme.webp', price: 2950 },
  { name: 'Gelin Arabası Süsü', image: '/images/products/pexels/gelin-arabasi.webp', price: 3250 },
  { name: 'Pembe Lilyum & Orkide Buketi', image: '/images/products/pexels/pembe-lilyum-orkide-buket.webp', price: 4250 },
  { name: 'Damat Yaka Çiçeği', price: 2500, badge: 'new' },
  { name: 'Söz Tepsisi', price: 3950 },
  { name: 'Nişan Yüzük Tepsisi', image: '/images/products/pexels/nisan-yuzuk-tepsisi.webp', price: 3650, featured: true },
  { name: 'Beyaz Lilyum & Gül Buketi', image: '/images/products/pexels/beyaz-lilyum-gul-buket.webp', price: 4750, oldPrice: 5500, badge: 'premium', featured: true },
  { name: 'Şakayık Gelin Buketi', image: '/images/products/pexels/sakayik-gelin-buketi.webp', price: 5500, motif: 'peony', badge: 'premium' },
]

const CORPORATE: Entry[] = [
  { name: 'Açılış Çelengi', price: 3500, featured: true },
  { name: 'Tören Çelengi', price: 3250 },
  { name: 'Ferforje Aranjman', image: '/images/products/pexels/ferforje.webp', price: 5500, oldPrice: 6500, badge: 'premium', featured: true },
  { name: 'Kurumsal Masa Çiçeği', image: '/images/products/pexels/kurumsal-masa.webp', price: 2750 },
  { name: 'Ofis Orkidesi', image: '/images/products/pexels/ofis-orkidesi.webp', price: 3250, motif: 'orchid', badge: 'holland' },
  { name: 'Açılış Çiçeği', image: '/images/products/pexels/acilis-cicegi.webp', price: 3850, featured: true },
  { name: 'Kutlama Aranjmanı', image: '/images/products/pexels/kutlama-aranjmani.webp', price: 4250, oldPrice: 4900 },
